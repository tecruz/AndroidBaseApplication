...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory
{
    ...
    private static class RxCallAdapterWrapper<R> implements CallAdapter<R, Object>
    {
        ...
        public Object adapt (Call<R> call)
        {
            ...
            {
                return (( Single ) result).onErrorResumeNext( new Function<Throwable,
                        SingleSource>( )
                {
                    @Override
            ...
            {
                return (( Observable ) result).onErrorResumeNext( new Function<Throwable,
                        ObservableSource>( )
                {
                    @Override
            ...
            {
                return (( Completable ) result).onErrorResumeNext( new Function<Throwable,
                        CompletableSource>( )
                {
                    @Override
